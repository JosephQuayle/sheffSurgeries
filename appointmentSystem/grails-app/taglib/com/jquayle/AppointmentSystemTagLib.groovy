...
class AppointmentSystemTagLib {
	...
	out << "<span style=float: left; padding-left: px;margin-left:px'>"
	out << "Welcome ${session.user}.<br>"
	out << "</span><span style='float:right;margin-right:px'>"
	out << "<a href='${createLink(controller:'Receptionist', action:'logout')}'<button type='button' class='btn link'>"
	out << "Logout </button></a></span>"
	}else{
	
	out << "<span style='float:right;margin-right:px'>"
	...
	out << "<div style ='margin-left:px 0 0px;'>"
